...
3. Commit and push to `main`. After Pages deploys, refresh — the dashboard re-fetches `js/data.js` every load (no version string to bump).
...
- **BMI** = `(weight_lb / 66²) × 703`, plotted on WHO adult zones (18.5 / 25 / 30)
